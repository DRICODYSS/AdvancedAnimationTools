...
#include "AdvancedAnimationToolsInteractiveTool.generated.h"


/**
 * Builder for UAdvancedAnimationToolsInteractiveTool
 */
UCLASS()
class ADVANCEDANIMATIONTOOLS_API UAdvancedAnimationToolsInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UAdvancedAnimationToolsInteractiveTool
 */
UCLASS(Transient)
class ADVANCEDANIMATIONTOOLS_API UAdvancedAnimationToolsInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UAdvancedAnimationToolsInteractiveToolProperties();
...
/**
 * UAdvancedAnimationToolsInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class ADVANCEDANIMATIONTOOLS_API UAdvancedAnimationToolsInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UAdvancedAnimationToolsInteractiveToolProperties> Properties;
