...
#include "AdvancedAnimationToolsInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "UAdvancedAnimationToolsInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* UAdvancedAnimationToolsInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	UAdvancedAnimationToolsInteractiveTool* NewTool = NewObject<UAdvancedAnimationToolsInteractiveTool>(SceneState.ToolManager);
...
UAdvancedAnimationToolsInteractiveToolProperties::UAdvancedAnimationToolsInteractiveToolProperties()
{
...
void UAdvancedAnimationToolsInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void UAdvancedAnimationToolsInteractiveTool::Setup()
{
	...
	Properties = NewObject<UAdvancedAnimationToolsInteractiveToolProperties>(this, "Measurement");
...
void UAdvancedAnimationToolsInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit UAdvancedAnimationToolsInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UAdvancedAnimationToolsInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UAdvancedAnimationToolsInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UAdvancedAnimationToolsInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UAdvancedAnimationToolsInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void UAdvancedAnimationToolsInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UAdvancedAnimationToolsInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UAdvancedAnimationToolsInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{
